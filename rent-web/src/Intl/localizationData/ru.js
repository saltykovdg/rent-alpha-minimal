export default {
  ...
  messages: {
    ...
    rolesTitle: 'Роли',
    roleFieldName: 'Роль',
    roleFieldDescription: 'Описание',
    editPageEditRoleTitle: 'Редактирование роли',
    usersTitle: 'Пользователи',
    userFieldLogin: 'Логин',
    userFieldPassword: 'Пароль',
    userFieldFirstName: 'Имя',
    userFieldLastName: 'Фамилия',
    userFieldFatherName: 'Отчество',
    userFieldEmail: 'Электронная почта',
    userFieldBlocked: 'Заблокирован',
    userFieldOnline: 'Статус онлайн',
    buttonCreateUser: 'Создать нового пользователя',
    editPageCreateUserTitle: 'Создание пользователя',
    editPageEditUserTitle: 'Редактирование пользователя',
